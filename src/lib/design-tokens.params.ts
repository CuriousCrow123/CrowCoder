...
const params: ParamDef[] = [
  { key: "proseMaxWidth", label: "Prose Column Width", type: "number", value: 900, min: 500, max: 900, step: 10, unit: "px" },
  ...
  { key: "accentColor", label: "Accent Color", type: "color", value: "#4f46e5" },
